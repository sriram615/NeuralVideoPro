...
def client():
    ...
    src_db = PROJECT_ROOT / "data" / "qdrant_db"
    test_db = PROJECT_ROOT / "data" / "_test_api_qdrant_db"
...
class TestEvalSuite:
    ...
    def test_ground_truth_dataset_loading(self):
        from eval_suite import load_ground_truth_benchmark
    ...
    def test_eval_suite_strict_math_bounds(self, client):
        from eval_suite import evaluate_pipeline
    ...
    def test_ablation_study_execution(self, client):
        from eval_suite import run_ablation_study
        from api import get_pipeline
        pipeline = get_pipeline()
    ...
    def test_qualitative_case_studies_generation(self, client):
        from eval_suite import generate_qualitative_case_studies
        from api import get_pipeline
        pipeline = get_pipeline()
