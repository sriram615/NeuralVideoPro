...
def batch_ingest_directory(
    input_dir: Union[str, Path] = "data/raw/raw_videos",
    domain: str = "news",
...
def main() -> None:
    ...
    parser.add_argument(
        "--dir",
        type=str,
        default="data/raw/raw_videos",
        help="Target directory containing video files (default: data/raw/raw_videos)",
    )
    parser.add_argument(
        "--domain",
        default="news",
        help="Domain metadata tag (default: news)",
    )
    parser.add_argument(
        "--db-path",
        default="./data/vectors/qdrant_db",
        help="Qdrant database directory (default: ./data/vectors/qdrant_db)",
    )
