...
@st.cache_resource
def get_pipeline(db_path: str = "./data/vectors/qdrant_db") -> VideoSearchPipeline:
...
def find_source_video(video_id: str) -> Optional[Path]:
    """Locate source video file in data/raw/raw_videos matching video_id stem."""
    raw_dir = Path("./data/raw/raw_videos")
