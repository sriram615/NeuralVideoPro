...
BENCHMARK_JSON_PATH = PROJECT_ROOT / "backend" / "tests" / "data" / "ground_truth_benchmark.json"
...
def generate_qualitative_case_studies(pipeline: Optional[VideoSearchPipeline] = None) -> List[Dict[str, Any]]:
    ...
    # Save to backend/tests/data/qualitative_case_studies.json
    out_file = PROJECT_ROOT / "backend" / "tests" / "data" / "qualitative_case_studies.json"
